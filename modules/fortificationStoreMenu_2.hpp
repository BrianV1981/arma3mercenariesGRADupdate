    ...
    class fortificationStore_2 {
		...
		class fortifications {
			...
			class I_EAF_supplyCrate_F {
                displayName = "Basic FOB Bundle";
                description = "The Basic FOB Bundle is an assortmant of base building parts that can be utilize with the ACE self interaction menu.";
                price = 10000;
                stock = 10000;
				code = "if (player == (_this select 0)) then {[container_2,'I_EAF_supplyCrate_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is loacted outside, it is the military-green huron cargo container. Use ACE interaction > Fortifications.';";
            };
			class I_E_CargoNet_01_ammo_F {
                displayName = "Advanced FOB Bundle";
                description = "The Advanced FOB Bundle is an assortmant of base building parts that can be utilize with the ACE self interaction menu.";
                price = 100000;
                stock = 10000;
				code = "if (player == (_this select 0)) then {[container_2,'I_E_CargoNet_01_ammo_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is loacted outside, it is the military-green huron cargo container. Use ACE interaction > Fortifications.';";
            };
			class Box_EAF_Equip_F {
                displayName = "Basic Road Block Bundle";
                description = "The Basic Road Block Bundle is an assortmant of base building parts that can be utilize with the ACE self interaction menu.";
                price = 10000;
                stock = 10000;
				code = "if (player == (_this select 0)) then {[container_2,'Box_EAF_Equip_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is loacted outside, it is the military-green huron cargo container. Use ACE interaction > Fortifications.';";
            };
		...
		class Lfortifications {
			...
			class Land_PaperBox_01_small_closed_brown_food_F {
                displayName = "IDAP Humanitarian Aid Box (MRE's and Water Bottels)"; 
                description = "The IDAP Humanitarian Aid Box has 75 Tomato Soup MRE's and 25 Water Bottles. You can deployed it with the ACE Self Interaction Menu > Equipment > Fortifications.";
                price = 200;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_2,'Land_PaperBox_01_small_closed_brown_food_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is loacted outside, it is the military-green huron cargo container. Use ACE interaction > Fortifications.';";
            };
