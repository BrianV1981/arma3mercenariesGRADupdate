    ...
    class fortificationStore_1 {
		...
		class fortifications {
			...
			class I_EAF_supplyCrate_F {
                ...
                price = 10000;
                stock = 10000;
				code = "if (player == (_this select 0)) then {[container_1,'I_EAF_supplyCrate_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is loacted outside, it is the military-green huron cargo container. Use ACE interaction > Fortifications.';";
            };
			...
			class Box_EAF_Equip_F {
                ...
                price = 10000;
                stock = 10000;
				code = "if (player == (_this select 0)) then {[container_1,'Box_EAF_Equip_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is loacted outside, it is the military-green huron cargo container. Use ACE interaction > Fortifications.';";
            };
